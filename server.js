...
const defaultData = {
  users: {},           // email -> { password, uid, banned, plan, isAdmin? }
  admins: ['nextechince@gmail.com'], // hardcoded root admin
  licenses: {}         // token -> { plan, uid, used? }
};
...
app.post('/api/user/metrics', (req, res) => {
  const { uid } = req.body;
  // Mock metrics – you can extend later
...
// ---------- PAIRING ENDPOINTS (unchanged from before) ----------
const codeStore = {};
const activeSockets = {};
